...
export const SignalGardenPage: React.FC = () => {
    // SEO
    useEffect(() => {
        document.title = "Signal Garden | TAREN Experiments";
        ...
        updateMeta('description', 'Intro to Signal Garden - Resonant geometry blooming in time.');
    }, []);
        ...
        <div className="flex min-h-[80vh] flex-col items-center justify-center px-4 py-12">
            <div className="w-full max-w-lg text-center animate-in fade-in slide-in-from-bottom-4 duration-1000">
                ...
                <div className="space-y-4 text-lg italic text-foreground/40 leading-relaxed mb-12">
                    <p>"Resonant geometry blooming in time."</p>
                    <p>"Tap to plant a pulse."</p>
                </div>

                <Link
                    to="/experiments/signal-garden/play"
                ...
                <p className="mt-8 text-[10px] font-black uppercase tracking-[0.25em] text-foreground/20">
                    Tap / Click to plant. Hold to sustain.
                </p>
            </div>
        </div>
    );
