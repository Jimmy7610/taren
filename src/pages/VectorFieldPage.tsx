...
export const VectorFieldPage: React.FC = () => {
    // SEO
    useEffect(() => {
        document.title = "Vector Field | TAREN Experiments";
        ...
        updateMeta('description', 'Intro to Vector Field - Flowing paths carved by hidden forces.');
    }, []);
        ...
        <div className="flex min-h-[80vh] flex-col items-center justify-center px-4 py-12">
            <div className="w-full max-w-lg text-center animate-in fade-in slide-in-from-bottom-4 duration-1000">
                <div className="mx-auto mb-8 flex h-20 w-20 items-center justify-center rounded-3xl bg-accent/5 ring-1 ring-accent/20">
                    <Move className="h-10 w-10 text-accent" />
                </div>
                ...
                <div className="space-y-4 text-lg italic text-foreground/40 leading-relaxed mb-12">
                    <p>"Hidden forces, visible paths."</p>
                    <p>"Drag to reveal the flow."</p>
                </div>

                <Link
                    to="/experiments/vector-field/play"
